...
model1_vals_broom <- 
  model1 %>% 
  augment() #fungsi untuk menambahkan kolom2 baru berisi nilai statistik lainnya yang dapat digunakan dalam menggambarkan nilai yang observasi dengan nilai prediksi
...
```{r}
model1_vals_broom
model1_vals_modelr #data asi + prediktif + residual
```
